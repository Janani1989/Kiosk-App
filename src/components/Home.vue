  ...
  <div class="container" class="col-xs-8 col-md-8">
   ...
   <div class="row top10">
    <div class="form-group" class="col-xs-12 col-md-12">
      <input type="text" class="form-control" v-validate="'required'" placeholder="Full Name" v-model="name" name="name">
    ...
    <div class="row top10">
    <div class="form-group" class="col-xs-12 col-md-12">
      <input type="text" class="form-control" v-validate="'required'" placeholder="Telephone Number" v-model="telephone" name="telephone">
    ...
    <label for="isOfficialVisit"  >Official Visit? </label>
    </div>
   ...
   <div class="row top10">
    ...
    <div class="col-xs-push-3 col-md-push-3">
    <label for="isEscortRequired"> Escort Required? </label>
    </div>
    ...
    <input type="text" class="form-control"  v-model="escortName" name="escortName" placeholder="Escort's Name">
    <p class="text-danger" align="left" v-if="errors.has('escortName')">{{ errors.first('escortName') }}</p>
    </div>
    </div>
    <div class="row top10">
    <button class="btn btn-success" type="submit" on-click=location.reload()>Register</button>
    </div>
    </form>
